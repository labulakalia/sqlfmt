...
type ZoneConfig struct {
	...
	// https://sqlfmt/cockroach/blob/master/docs/RFCS/20160706_expressive_zone_config.md#constraint-system
	//
...
type SubzoneSpan struct {
	...
	Key github_com_cockroachdb_cockroach_pkg_roachpb.Key `protobuf:"bytes,1,opt,name=key,casttype=sqlfmt/cockroach/pkg/roachpb.Key" json:"key,omitempty"`
	...
	EndKey github_com_cockroachdb_cockroach_pkg_roachpb.Key `protobuf:"bytes,2,opt,name=end_key,json=endKey,casttype=sqlfmt/cockroach/pkg/roachpb.Key" json:"end_key,omitempty"`

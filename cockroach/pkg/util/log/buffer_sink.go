...
// See: https://sqlfmt/cockroach/issues/72453
//
	...
	for {
		...
		appendMessage := func(m bufferSinkMessage) {
			...
			if m.flush || m.errorCh != nil || (bs.triggerSize > 0 && b.byteLen > bs.triggerSize) {
				...
				// See: https://sqlfmt/cockroach/issues/72454
				b.errorCh = m.errorCh
		...
		case <-ctx.Done():
			...
			// See: https://sqlfmt/cockroach/issues/72455
			select {
			case m := <-bs.messageCh:
				appendMessage(m)
			default:
		...
		if flush {
			...
			// See: https://sqlfmt/cockroach/issues/72460
...
// See: https://sqlfmt/cockroach/issues/72458
//
...
// requested.
// See: https://sqlfmt/cockroach/issues/72459
...
type bufferSinkBundle struct {
	...
	// https://sqlfmt/cockroach/issues/72453
	droppedCount int

...
// For example:
//
//     /home/kena/src/go/src/sqlfmt/cockroach/pkg/util/caller
//                           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ crdb package path
//     ^^^^^^^^^^^^^^^^^^^^^^ package build root
//
...
func findFileAndPackageRoot() (ok bool, crdbPath string, srcRoot string) {
	...
	// For example:
	//     sqlfmt/cockroach/pkg/util/caller.findFileAndPackageRoot
	...
	//   sqlfmt/cockroach/pkg/util/caller/resolver.go
	//

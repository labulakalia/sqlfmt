...
type RecursiveAndUncloneable struct {
	...
	Uuid github_com_cockroachdb_cockroach_pkg_util_uuid.UUID `protobuf:"bytes,2,opt,name=uuid,proto3,customtype=sqlfmt/cockroach/pkg/util/uuid.UUID" json:"uuid"`
}

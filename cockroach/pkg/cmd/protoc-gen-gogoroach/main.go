...
var builtinRegex *regexp.Regexp = regexp.MustCompile(`sqlfmt/cockroach/pkg/(?P<capture>(bytes|context|encoding/binary|errors|fmt|io|math|github\.com|(google\.)?golang\.org)([^a-z]|$$))`)

...
func TestPost(t *testing.T) {
	...
	testCases := []testCase{
		{
			name:        "failure",
			packageName: "sqlfmt/cockroach/pkg/storage",
...
`,
		...
		{
			name:        "rsg-crash",
			packageName: "sqlfmt/cockroach/pkg/sql/tests",
...
`,
		...
		},
		{
			...
			packageName: "sqlfmt/cockroach/pkg/cmd/roachtest",
...
func TestPostEndToEnd(t *testing.T) {
	...
	req := PostRequest{
		PackageName: "sqlfmt/cockroach/pkg/foo/bar",

...
func TestPost(t *testing.T) {
	...
	testCases := []testCase{
		{
			name:        "failure",
			packageName: "github.com/labulakalia/sqlfmt/cockroach/pkg/storage",
...
`,
		...
		{
			name:        "rsg-crash",
			packageName: "github.com/labulakalia/sqlfmt/cockroach/pkg/sql/tests",
...
test logs left over in: /go/src/sqlfmt/cockroach/artifacts/logTestRandomSyntaxSQLSmith460792454
...
`,
		...
		},
		{
			...
			packageName: "github.com/labulakalia/sqlfmt/cockroach/pkg/cmd/roachtest",
			testName:    "some-roachtest",
			message:     "boom",
			reproURL:    "https://sqlfmt/cockroach",
...
func TestPostEndToEnd(t *testing.T) {
	...
	req := PostRequest{
		PackageName: "github.com/labulakalia/sqlfmt/cockroach/pkg/foo/bar",
...
func ghURL(t *testing.T, title, body string) string {
	u, err := url.Parse("https://sqlfmt/cockroach/issues/new")

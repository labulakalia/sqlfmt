...
import (
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/util/search"
...
type tpccOptions struct {
	...
	//
	// TODO(tbg): remove this once https://sqlfmt/cockroach/issues/74705 is completed.
...
func (d tpccBenchDistribution) zones() []string {
	...
	case multiZone:
		...
		// https://sqlfmt/cockroach/issues/66184
...
func (s tpccBenchSpec) startOpts() (option.StartOpts, install.ClusterSettings) {
	...
	// See https://sqlfmt/cockroach/issues/75071.
...
func runTPCCBench(ctx context.Context, t test.Test, c cluster.Cluster, b tpccBenchSpec) {
	...
	restart := func() {
		...
		if err := c.Reset(ctx, t.L()); err != nil {
			...
			// https://sqlfmt/cockroach/issues/61981#issuecomment-826838740
...
func registerTPCCBench(r registry.Registry) {
	specs := []tpccBenchSpec{
		...
		// See https://sqlfmt/cockroach/issues/31409 for the next three specs.
		{
			Nodes: 6,
			CPUs:  16,

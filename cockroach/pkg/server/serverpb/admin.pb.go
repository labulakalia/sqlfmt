...
import (
	...
	fmt "fmt"
	zonepb "github.com/labulakalia/sqlfmt/cockroach/pkg/config/zonepb"
	...
	catalog "github.com/labulakalia/sqlfmt/cockroach/pkg/ts/catalog"
	metric "github.com/labulakalia/sqlfmt/cockroach/pkg/util/metric"
...
type DatabaseDetailsResponse_Stats struct {
	...
	NodeIDs []github_com_cockroachdb_cockroach_pkg_roachpb.NodeID `protobuf:"varint,4,rep,packed,name=node_ids,json=nodeIds,proto3,casttype=sqlfmt/cockroach/pkg/roachpb.NodeID" json:"node_ids,omitempty"`
}
...
type TableStatsResponse struct {
	...
	NodeIDs []github_com_cockroachdb_cockroach_pkg_roachpb.NodeID `protobuf:"varint,7,rep,packed,name=node_ids,json=nodeIds,proto3,casttype=sqlfmt/cockroach/pkg/roachpb.NodeID" json:"node_ids,omitempty"`
}
...
type DecommissionStatusRequest struct {
	NodeIDs []github_com_cockroachdb_cockroach_pkg_roachpb.NodeID `protobuf:"varint,1,rep,packed,name=node_ids,json=nodeIds,proto3,casttype=sqlfmt/cockroach/pkg/roachpb.NodeID" json:"node_ids,omitempty"`
}
...
type DecommissionStatusResponse_Status struct {
	NodeID github_com_cockroachdb_cockroach_pkg_roachpb.NodeID `protobuf:"varint,1,opt,name=node_id,json=nodeId,proto3,casttype=sqlfmt/cockroach/pkg/roachpb.NodeID" json:"node_id,omitempty"`
...
type LivenessResponse struct {
	...
	Statuses   map[github_com_cockroachdb_cockroach_pkg_roachpb.NodeID]livenesspb.NodeLivenessStatus `protobuf:"bytes,2,rep,name=statuses,proto3,castkey=sqlfmt/cockroach/pkg/roachpb.NodeID" json:"statuses" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3,enum=cockroach.kv.kvserver.liveness.livenesspb.NodeLivenessStatus"`
}
...
type JobResponse struct {
	...
	DescriptorIDs     []github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.ID `protobuf:"varint,5,rep,packed,name=descriptor_ids,json=descriptorIds,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/descpb.ID" json:"descriptor_ids,omitempty"`
...
func (*JobResponse_ExecutionFailure) Descriptor() ([]byte, []int) {
	return fileDescriptor_0b2ccb6a0551fa7e, []int{34, 0}
}
...
type DataDistributionResponse_TableInfo struct {
	ReplicaCountByNodeId map[github_com_cockroachdb_cockroach_pkg_roachpb.NodeID]int64 `protobuf:"bytes,1,rep,name=replica_count_by_node_id,json=replicaCountByNodeId,proto3,castkey=sqlfmt/cockroach/pkg/roachpb.NodeID" json:"replica_count_by_node_id,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
...
type EnqueueRangeRequest struct {
	...
	RangeID github_com_cockroachdb_cockroach_pkg_roachpb.RangeID `protobuf:"varint,3,opt,name=range_id,json=rangeId,proto3,casttype=sqlfmt/cockroach/pkg/roachpb.RangeID" json:"range_id,omitempty"`
...
type GetTraceRequest struct {
	...
	SnapshotID    int64                                                               `protobuf:"varint,1,opt,name=snapshot_id,json=snapshotId,proto3" json:"snapshot_id,omitempty"`
	TraceID       github_com_cockroachdb_cockroach_pkg_util_tracing_tracingpb.TraceID `protobuf:"varint,2,opt,name=trace_id,json=traceId,proto3,customtype=sqlfmt/cockroach/pkg/util/tracing/tracingpb.TraceID" json:"trace_id"`
...
type TracingSpan struct {
	...
	Start         *time.Time `protobuf:"bytes,5,opt,name=start,proto3,stdtime" json:"start,omitempty"`
...
type SetTraceRecordingTypeRequest struct {
	...
	// specified.
	TraceID github_com_cockroachdb_cockroach_pkg_util_tracing_tracingpb.TraceID `protobuf:"varint,1,opt,name=trace_id,json=traceId,proto3,customtype=sqlfmt/cockroach/pkg/util/tracing/tracingpb.TraceID" json:"trace_id"`
	...
	SpanID        github_com_cockroachdb_cockroach_pkg_util_tracing_tracingpb.SpanID `protobuf:"varint,2,opt,name=span_id,json=spanId,proto3,customtype=sqlfmt/cockroach/pkg/util/tracing/tracingpb.SpanID" json:"span_id"`
...
var fileDescriptor_0b2ccb6a0551fa7e = []byte{
	...
	,
}
...
func (c *adminClient) SendKVBatch(ctx context.Context, in *roachpb.BatchRequest, opts ...grpc.CallOption) (*roachpb.BatchResponse, error) {
	out := new(roachpb.BatchResponse)
...
func (*UnimplementedAdminServer) SendKVBatch(ctx context.Context, req *roachpb.BatchRequest) (*roachpb.BatchResponse, error) {
...
func _Admin_SendKVBatch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServer).SendKVBatch(ctx, req.(*roachpb.BatchRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (m *JobResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DescriptorIDs) > 0 {
		...
		i = encodeVarintAdmin(dAtA, i, uint64(j27))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Username) > 0 {
...
func (m *JobResponse_ExecutionFailure) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.End != nil {
		n29, err29 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.End, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.End):])
		if err29 != nil {
			return 0, err29
		}
		i -= n29
	...
	if m.Start != nil {
		n30, err30 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.Start, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.Start):])
		if err30 != nil {
			return 0, err30
		}
		i -= n30
...
func (m *DataDistributionResponse_TableInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.DroppedAt != nil {
		n36, err36 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.DroppedAt, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.DroppedAt):])
		if err36 != nil {
			return 0, err36
		}
		i -= n36
		i = encodeVarintAdmin(dAtA, i, uint64(n36))
		i--
		dAtA[i] = 0x1a
	}
	if m.ZoneConfigId != 0 {
...
func (m *SnapshotInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.CapturedAt != nil {
		n39, err39 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.CapturedAt, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.CapturedAt):])
		if err39 != nil {
			return 0, err39
		}
		i -= n39
		i = encodeVarintAdmin(dAtA, i, uint64(n39))
		i--
		dAtA[i] = 0x12
	}
	if m.SnapshotID != 0 {
...
func (m *TracingSnapshot) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.CapturedAt != nil {
		n42, err42 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.CapturedAt, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.CapturedAt):])
		if err42 != nil {
			return 0, err42
		}
		i -= n42
		i = encodeVarintAdmin(dAtA, i, uint64(n42))
		i--
		dAtA[i] = 0x12
	}
	if m.SnapshotID != 0 {
...
func (m *TracingSpan) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Start != nil {
		n43, err43 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.Start, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.Start):])
		if err43 != nil {
			return 0, err43
		}
		i -= n43
		i = encodeVarintAdmin(dAtA, i, uint64(n43))
		i--
		dAtA[i] = 0x2a
	}
	if m.ParentSpanID != 0 {

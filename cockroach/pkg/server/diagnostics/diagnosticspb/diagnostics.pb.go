...
type SQLInstanceInfo struct {
	...
	SQLInstanceID github_com_cockroachdb_cockroach_pkg_base.SQLInstanceID `protobuf:"varint,1,opt,name=sql_instance_id,json=sqlInstanceId,proto3,casttype=sqlfmt/cockroach/pkg/base.SQLInstanceID" json:"sql_instance_id,omitempty"`

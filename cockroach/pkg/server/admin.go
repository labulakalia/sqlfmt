...
import (
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/ts/catalog"
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/util/tracing/tracingui"
...
func (s *adminServer) checkReadinessForHealthCheck(ctx context.Context) error {
	...
	// https://sqlfmt/cockroach/issues/45123
...
func (s *adminServer) decommissionStatusHelper(
	...
	livenessMap := map[roachpb.NodeID]livenesspb.Liveness{}
	{
		...
		// For an example, see:
		//
		// https://sqlfmt/cockroach/issues/73636

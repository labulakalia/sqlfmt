...
import (
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/migration/migrations"
...
func TestClusterVersionUpgrade(t *testing.T) {
	defer leaktest.AfterTest(t)()
	defer log.Scope(t).Close(t)
	skip.WithIssue(t, 74599, "flaky test")
	ctx := context.Background()
...

	{
		...
		// https://sqlfmt/cockroach/pull/39640#pullrequestreview-275532068
		//

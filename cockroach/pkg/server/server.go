...
import (
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/jobs/jobsprotectedts"
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/kv/kvprober"
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/kv/kvserver/protectedts/ptprovider"
	"github.com/labulakalia/sqlfmt/cockroach/pkg/kv/kvserver/protectedts/ptreconcile"
	serverrangefeed "github.com/labulakalia/sqlfmt/cockroach/pkg/kv/kvserver/rangefeed"
	"github.com/labulakalia/sqlfmt/cockroach/pkg/kv/kvserver/reports"
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/server/systemconfigwatcher"
	"github.com/labulakalia/sqlfmt/cockroach/pkg/server/telemetry"
	"github.com/labulakalia/sqlfmt/cockroach/pkg/server/tenantsettingswatcher"
	"github.com/labulakalia/sqlfmt/cockroach/pkg/settings/cluster"
	"github.com/labulakalia/sqlfmt/cockroach/pkg/spanconfig"
	_ "github.com/labulakalia/sqlfmt/cockroach/pkg/spanconfig/spanconfigjob" // register jobs declared outside of pkg/sql
	"github.com/labulakalia/sqlfmt/cockroach/pkg/spanconfig/spanconfigkvaccessor"
	"github.com/labulakalia/sqlfmt/cockroach/pkg/spanconfig/spanconfigkvsubscriber"
	"github.com/labulakalia/sqlfmt/cockroach/pkg/spanconfig/spanconfigptsreader"
	...
	_ "github.com/labulakalia/sqlfmt/cockroach/pkg/sql/gcjob"    // register jobs declared outside of pkg/sql
	_ "github.com/labulakalia/sqlfmt/cockroach/pkg/sql/importer" // register jobs/planHooks declared outside of pkg/sql
	"github.com/labulakalia/sqlfmt/cockroach/pkg/sql/optionalnodeliveness"
	"github.com/labulakalia/sqlfmt/cockroach/pkg/sql/pgwire"
	_ "github.com/labulakalia/sqlfmt/cockroach/pkg/sql/schemachanger/scjob" // register jobs declared outside of pkg/sql
	_ "github.com/labulakalia/sqlfmt/cockroach/pkg/sql/ttl/ttljob"          // register jobs declared outside of pkg/sql
	_ "github.com/labulakalia/sqlfmt/cockroach/pkg/sql/ttl/ttlschedule"     // register schedules declared outside of pkg/sql
	"github.com/labulakalia/sqlfmt/cockroach/pkg/storage/enginepb"
	"github.com/labulakalia/sqlfmt/cockroach/pkg/ts"
	"github.com/labulakalia/sqlfmt/cockroach/pkg/util"
	"github.com/labulakalia/sqlfmt/cockroach/pkg/util/admission"
	"github.com/labulakalia/sqlfmt/cockroach/pkg/util/goschedstats"
...
func (s *Server) PreStart(ctx context.Context) error {
	...
	//
	// See https://sqlfmt/cockroach/issues/73897.

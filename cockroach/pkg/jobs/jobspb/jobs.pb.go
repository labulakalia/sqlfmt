...
type RestoreValidation int32

const (
	RestoreValidation_DefaultRestore RestoreValidation = 0
)

var RestoreValidation_name = map[int32]string{
	0: "DefaultRestore",
}

var RestoreValidation_value = map[string]int32{
	"DefaultRestore": 0,
}

func (x RestoreValidation) String() string {
	return proto.EnumName(RestoreValidation_name, int32(x))
}

func (RestoreValidation) EnumDescriptor() ([]byte, []int) {
...
type StreamReplicationDetails struct {
	...
	ProtectedTimestampRecord *github_com_cockroachdb_cockroach_pkg_util_uuid.UUID `protobuf:"bytes,2,opt,name=protected_timestamp_record,json=protectedTimestampRecord,proto3,customtype=sqlfmt/cockroach/pkg/util/uuid.UUID" json:"protected_timestamp_record,omitempty"`
}
...
type SchedulePTSChainingRecord struct {
	ProtectedTimestampRecord *github_com_cockroachdb_cockroach_pkg_util_uuid.UUID `protobuf:"bytes,1,opt,name=protected_timestamp_record,json=protectedTimestampRecord,proto3,customtype=sqlfmt/cockroach/pkg/util/uuid.UUID" json:"protected_timestamp_record,omitempty"`
...
type BackupDetails struct {
	...
	ProtectedTimestampRecord *github_com_cockroachdb_cockroach_pkg_util_uuid.UUID `protobuf:"bytes,7,opt,name=protected_timestamp_record,json=protectedTimestampRecord,proto3,customtype=sqlfmt/cockroach/pkg/util/uuid.UUID" json:"protected_timestamp_record,omitempty"`
	...
	ResolvedCompleteDbs []github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.ID `protobuf:"varint,18,rep,packed,name=resolved_complete_dbs,json=resolvedCompleteDbs,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/descpb.ID" json:"resolved_complete_dbs,omitempty"`
}
...
type DescriptorRewrite struct {
	ID             github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.ID `protobuf:"varint,1,opt,name=id,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/descpb.ID" json:"id,omitempty"`
	ParentID       github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.ID `protobuf:"varint,2,opt,name=parent_id,json=parentId,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/descpb.ID" json:"parent_id,omitempty"`
	ParentSchemaID github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.ID `protobuf:"varint,5,opt,name=parent_schema_id,json=parentSchemaId,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/descpb.ID" json:"parent_schema_id,omitempty"`
...
type RestoreDetails struct {
	...
	DescriptorRewrites map[github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.ID]*DescriptorRewrite `protobuf:"bytes,2,rep,name=descriptor_rewrites,json=descriptorRewrites,proto3,castkey=sqlfmt/cockroach/pkg/sql/catalog/descpb.ID" json:"descriptor_rewrites,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	...
	DescriptorCoverage   github_com_cockroachdb_cockroach_pkg_sql_sem_tree.DescriptorCoverage `protobuf:"varint,11,opt,name=descriptor_coverage,json=descriptorCoverage,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/tree.DescriptorCoverage" json:"descriptor_coverage,omitempty"`
	...
	// being restored.
	DatabaseModifiers map[github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.ID]*RestoreDetails_DatabaseModifier `protobuf:"bytes,19,rep,name=database_modifiers,json=databaseModifiers,proto3,castkey=sqlfmt/cockroach/pkg/sql/catalog/descpb.ID" json:"database_modifiers,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	...
	Validation RestoreValidation `protobuf:"varint,24,opt,name=validation,proto3,enum=cockroach.sql.jobs.jobspb.RestoreValidation" json:"validation,omitempty"`
}
...
type RestoreDetails_RevalidateIndex struct {
	TableID github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.ID      `protobuf:"varint,1,opt,name=id,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/descpb.ID" json:"id,omitempty"`
	IndexID github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.IndexID `protobuf:"varint,2,opt,name=parent_id,json=parentId,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/descpb.IndexID" json:"parent_id,omitempty"`
}
...
func (*RestoreDetails_RevalidateIndex) Descriptor() ([]byte, []int) {
	return fileDescriptor_6c315f3a2536c4ef, []int{10, 3}
}
...
type ImportDetails struct {
	...
	ParentID   github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.ID `protobuf:"varint,6,opt,name=parent_id,json=parentId,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/descpb.ID" json:"parent_id,omitempty"`
	...
	// does not run the code to do so. To deal with this there is a background
	// reconciliation loop to ensure that protected timestamps are cleaned up.
	ProtectedTimestampRecord *github_com_cockroachdb_cockroach_pkg_util_uuid.UUID `protobuf:"bytes,22,opt,name=protected_timestamp_record,json=protectedTimestampRecord,proto3,customtype=sqlfmt/cockroach/pkg/util/uuid.UUID" json:"protected_timestamp_record,omitempty"`
	...
	DatabasePrimaryRegion github_com_cockroachdb_cockroach_pkg_sql_catalog_catpb.RegionName `protobuf:"bytes,27,opt,name=database_primary_region,json=databasePrimaryRegion,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/catpb.RegionName" json:"database_primary_region,omitempty"`
}
...
type TypeSchemaChangeDetails struct {
	TypeID github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.ID `protobuf:"varint,1,opt,name=type_id,json=typeId,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/descpb.ID" json:"type_id,omitempty"`
...
type BackfillProgress struct {
	...
	// a merge.
	SourceIndexID github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.IndexID `protobuf:"varint,2,opt,name=source_index_id,json=sourceIndexId,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/descpb.IndexID" json:"source_index_id,omitempty"`
	// DestIndexIDs is the set of IDs which are being backfilled from the
	// SourceIndexID.
	DestIndexIDs []github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.IndexID `protobuf:"varint,3,rep,packed,name=dest_index_ids,json=destIndexIds,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/descpb.IndexID" json:"dest_index_ids,omitempty"`
...
type DroppedTableDetails struct {
	...
	ID     github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.ID `protobuf:"varint,2,opt,name=ID,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/descpb.ID" json:"ID,omitempty"`
...
type SchemaChangeGCDetails struct {
	...
	ParentID github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.ID `protobuf:"varint,3,opt,name=parent_id,json=parentId,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/descpb.ID" json:"parent_id,omitempty"`
	// Tenant to GC.
...
type SchemaChangeGCDetails_DroppedIndex struct {
	IndexID  github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.IndexID `protobuf:"varint,1,opt,name=index_id,json=indexId,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/descpb.IndexID" json:"index_id,omitempty"`
...
type SchemaChangeDetails struct {
	...
	DroppedTypes []github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.ID `protobuf:"varint,8,rep,packed,name=dropped_types,json=droppedTypes,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/descpb.ID" json:"dropped_types,omitempty"`
	// dropped_schemas holds the set of schemas to drop as part of a DROP SCHEMA
	// or DROP DATABASE cascade statement.
	DroppedSchemas []github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.ID `protobuf:"varint,9,rep,packed,name=dropped_schemas,json=droppedSchemas,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/descpb.ID" json:"dropped_schemas,omitempty"`
	// The descriptor ID of the dropped database which created this job.
	DroppedDatabaseID github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.ID `protobuf:"varint,4,opt,name=dropped_database_id,json=droppedDatabaseId,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/descpb.ID" json:"dropped_database_id,omitempty"`
	...
	DescID github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.ID `protobuf:"varint,5,opt,name=desc_id,json=descId,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/descpb.ID" json:"desc_id,omitempty"`
	...
	TableMutationID github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.MutationID `protobuf:"varint,6,opt,name=table_mutation_id,json=tableMutationId,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/descpb.MutationID" json:"table_mutation_id,omitempty"`
...
type ChangefeedTargetSpecification struct {
	...
	TableID           github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.ID `protobuf:"varint,2,opt,name=table_id,json=tableId,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/descpb.ID" json:"table_id,omitempty"`
...
type ChangefeedDetails struct {
	...
	//
	Tables  ChangefeedTargets `protobuf:"bytes,6,rep,name=tables,proto3,casttype=ChangefeedTargets,castkey=sqlfmt/cockroach/pkg/sql/catalog/descpb.ID" json:"tables" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
type ChangefeedProgress struct {
	...
	ProtectedTimestampRecord github_com_cockroachdb_cockroach_pkg_util_uuid.UUID `protobuf:"bytes,3,opt,name=protected_timestamp_record,json=protectedTimestampRecord,proto3,customtype=sqlfmt/cockroach/pkg/util/uuid.UUID" json:"protected_timestamp_record"`
}
...
type CreateStatsDetails_ColStat struct {
	ColumnIDs []github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.ColumnID `protobuf:"varint,1,rep,packed,name=column_ids,json=columnIds,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/descpb.ColumnID" json:"column_ids,omitempty"`
...
func (*CreateStatsDetails_ColStat) Descriptor() ([]byte, []int) {
	return fileDescriptor_6c315f3a2536c4ef, []int{35, 0}
}
...
type RowLevelTTLDetails struct {
	TableID github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.ID `protobuf:"varint,1,opt,name=table_id,json=tableId,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/descpb.ID" json:"table_id,omitempty"`
...
type Payload struct {
	...
	UsernameProto github_com_cockroachdb_cockroach_pkg_security.SQLUsernameProto `protobuf:"bytes,2,opt,name=username_proto,json=usernameProto,proto3,casttype=sqlfmt/cockroach/pkg/security.SQLUsernameProto" json:"username_proto,omitempty"`
	...
	DescriptorIDs  []github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.ID `protobuf:"varint,6,rep,packed,name=descriptor_ids,json=descriptorIds,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/descpb.ID" json:"descriptor_ids,omitempty"`
...
type Progress struct {
	...
	TraceID github_com_cockroachdb_cockroach_pkg_util_tracing_tracingpb.TraceID `protobuf:"varint,21,opt,name=trace_id,json=traceId,proto3,customtype=sqlfmt/cockroach/pkg/util/tracing/tracingpb.TraceID" json:"trace_id"`
}
...
type RetriableExecutionFailure struct {
	...
	InstanceID github_com_cockroachdb_cockroach_pkg_base.SQLInstanceID `protobuf:"varint,4,opt,name=instance_id,json=instanceId,proto3,customtype=sqlfmt/cockroach/pkg/base.SQLInstanceID" json:"instance_id"`
...
func init() {
	...
	proto.RegisterEnum("cockroach.sql.jobs.jobspb.RestoreValidation", RestoreValidation_name, RestoreValidation_value)
...
var fileDescriptor_6c315f3a2536c4ef = []byte{
	// 6915 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *RestoreDetails) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Validation != 0 {
		i = encodeVarintJobs(dAtA, i, uint64(m.Validation))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xc0
...
func (m *RowLevelTTLDetails) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	n56, err56 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.Cutoff, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(m.Cutoff):])
	if err56 != nil {
		return 0, err56
	}
	i -= n56
	i = encodeVarintJobs(dAtA, i, uint64(n56))
	i--
	dAtA[i] = 0x12
	if m.TableID != 0 {
		i = encodeVarintJobs(dAtA, i, uint64(m.TableID))
...
func (m *RestoreDetails) Size() (n int) {
	...
	if m.Validation != 0 {
		n += 2 + sovJobs(uint64(m.Validation))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 24:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Validation |= RestoreValidation(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}

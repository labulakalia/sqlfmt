...
type ChangeAggregatorSpec struct {
	...
	UserProto github_com_cockroachdb_cockroach_pkg_security.SQLUsernameProto `protobuf:"bytes,3,opt,name=user_proto,json=userProto,casttype=sqlfmt/cockroach/pkg/security.SQLUsernameProto" json:"user_proto"`
...
type ChangeFrontierSpec struct {
	...
	// User who initiated the changefeed. This is used to check access privileges
	// when using FileTable ExternalStorage.
	UserProto github_com_cockroachdb_cockroach_pkg_security.SQLUsernameProto `protobuf:"bytes,4,opt,name=user_proto,json=userProto,casttype=sqlfmt/cockroach/pkg/security.SQLUsernameProto" json:"user_proto"`
}

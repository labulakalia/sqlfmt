...
import (
	...
	_ "github.com/labulakalia/sqlfmt/cockroach/pkg/sql/catalog/catpb"
...
type BackfillerSpec struct {
	...
	IndexesToBackfill []github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.IndexID `protobuf:"varint,8,rep,name=indexes_to_backfill,json=indexesToBackfill,casttype=sqlfmt/cockroach/pkg/sql/catalog/descpb.IndexID" json:"indexes_to_backfill,omitempty"`
...
type ReadImportDataSpec struct {
	...
	UserProto github_com_cockroachdb_cockroach_pkg_security.SQLUsernameProto `protobuf:"bytes,15,opt,name=user_proto,json=userProto,casttype=sqlfmt/cockroach/pkg/security.SQLUsernameProto" json:"user_proto"`
	...
	DatabasePrimaryRegion github_com_cockroachdb_cockroach_pkg_sql_catalog_catpb.RegionName `protobuf:"bytes,17,opt,name=database_primary_region,json=databasePrimaryRegion,casttype=sqlfmt/cockroach/pkg/sql/catalog/catpb.RegionName" json:"database_primary_region"`
...
type BackupDataSpec struct {
	...
	// when using FileTable ExternalStorage.
	UserProto github_com_cockroachdb_cockroach_pkg_security.SQLUsernameProto `protobuf:"bytes,10,opt,name=user_proto,json=userProto,casttype=sqlfmt/cockroach/pkg/security.SQLUsernameProto" json:"user_proto"`
}
...
type ExportSpec struct {
	...
	// when using FileTable ExternalStorage.
	UserProto github_com_cockroachdb_cockroach_pkg_security.SQLUsernameProto `protobuf:"bytes,6,opt,name=user_proto,json=userProto,casttype=sqlfmt/cockroach/pkg/security.SQLUsernameProto" json:"user_proto"`
...
type IndexBackfillMergerSpec struct {
	Table            descpb.TableDescriptor                                            `protobuf:"bytes,1,opt,name=table" json:"table"`
	TemporaryIndexes []github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.IndexID `protobuf:"varint,2,rep,name=temporary_indexes,json=temporaryIndexes,casttype=sqlfmt/cockroach/pkg/sql/catalog/descpb.IndexID" json:"temporary_indexes,omitempty"`
	AddedIndexes     []github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.IndexID `protobuf:"varint,3,rep,name=added_indexes,json=addedIndexes,casttype=sqlfmt/cockroach/pkg/sql/catalog/descpb.IndexID" json:"added_indexes,omitempty"`
...
var fileDescriptor_6d46d06b67eadaca = []byte{
	...
	,
}

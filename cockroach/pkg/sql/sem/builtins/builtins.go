...
import (
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/sql/rowenc/keyside"
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/util/fuzzystrmatch"
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/util/ulid"
	"github.com/labulakalia/sqlfmt/cockroach/pkg/util/unaccent"
...
var builtins = map[string]builtinDefinition{
	...
	// See https://sqlfmt/cockroach/issues/21564
	"setval": makeBuiltin(
		tree.FunctionProperties{
			Category:             categorySequences,
			DistsqlBlocklist:     true,
...
value if you rely on the HLC for accuracy.`,
	...
	"timezone": makeBuiltin(defProps(),
		...
		tree.Overload{
			...
			// https://sqlfmt/cockroach/pull/51037 for details.
			IgnoreVolatilityCheck: true,
		},
		tree.Overload{
			Types: tree.ArgTypes{

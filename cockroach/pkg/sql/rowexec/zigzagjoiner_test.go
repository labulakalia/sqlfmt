...
import (
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/testutils/distsqlutils"
...
func TestZigzagJoiner(t *testing.T) {
	...
	// Drop a column to test https://sqlfmt/cockroach/issues/37196
	_, err := sqlDB.Exec("ALTER TABLE test.empty DROP COLUMN x")
	require.NoError(t, err)

	// Drop and add an index to test
	// https://sqlfmt/cockroach/issues/42164.

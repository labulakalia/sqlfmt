...
var varGen = map[string]sessionVar{
	...
	// TODO(bob): Remove or no-op this in v2.4: https://sqlfmt/cockroach/issues/32844
	`default_int_size`: {
		Get: func(evalCtx *extendedEvalContext) (string, error) {
		...
		Set: func(ctx context.Context, m sessionDataMutator, val string) error {
			...
			// TODO(bob): Change to 8 in v2.3: https://sqlfmt/cockroach/issues/32534
			if i == 4 {
	...
	// https://sqlfmt/cockroach/issues/30588

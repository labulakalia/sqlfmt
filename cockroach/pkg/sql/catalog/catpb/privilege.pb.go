...
type UserPrivileges struct {
	UserProto github_com_cockroachdb_cockroach_pkg_security.SQLUsernameProto `protobuf:"bytes,1,opt,name=user_proto,json=userProto,casttype=sqlfmt/cockroach/pkg/security.SQLUsernameProto" json:"user_proto"`
...
type PrivilegeDescriptor struct {
	...
	OwnerProto github_com_cockroachdb_cockroach_pkg_security.SQLUsernameProto `protobuf:"bytes,2,opt,name=owner_proto,json=ownerProto,casttype=sqlfmt/cockroach/pkg/security.SQLUsernameProto" json:"owner_proto"`
...
type DefaultPrivilegesForRole struct {
	...
	DefaultPrivilegesPerObject map[github_com_cockroachdb_cockroach_pkg_sql_sem_tree.AlterDefaultPrivilegesTargetObject]PrivilegeDescriptor `protobuf:"bytes,14,rep,name=default_privileges_per_object,json=defaultPrivilegesPerObject,castkey=sqlfmt/cockroach/pkg/sql/sem/tree.AlterDefaultPrivilegesTargetObject" json:"default_privileges_per_object" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
}

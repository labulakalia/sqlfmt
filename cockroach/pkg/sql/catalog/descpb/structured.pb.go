...
import (
	bytes "bytes"
	fmt "fmt"
	geoindex "github.com/labulakalia/sqlfmt/cockroach/pkg/geo/geoindex"
	...
	scpb "github.com/labulakalia/sqlfmt/cockroach/pkg/sql/schemachanger/scpb"
...
type ForeignKeyReference struct {
	...
	OnDelete        catpb.ForeignKeyAction `protobuf:"varint,6,opt,name=on_delete,json=onDelete,enum=cockroach.sql.catalog.catpb.ForeignKeyAction" json:"on_delete"`
	OnUpdate        catpb.ForeignKeyAction `protobuf:"varint,7,opt,name=on_update,json=onUpdate,enum=cockroach.sql.catalog.catpb.ForeignKeyAction" json:"on_update"`
...
type ForeignKeyConstraint struct {
	...
	OnDelete            catpb.ForeignKeyAction `protobuf:"varint,7,opt,name=on_delete,json=onDelete,enum=cockroach.sql.catalog.catpb.ForeignKeyAction" json:"on_delete"`
	OnUpdate            catpb.ForeignKeyAction `protobuf:"varint,8,opt,name=on_update,json=onUpdate,enum=cockroach.sql.catalog.catpb.ForeignKeyAction" json:"on_update"`
	// This is only important for composite keys. For all prior matches before
	// the addition of this value, MATCH SIMPLE will be used.
...
type TableDescriptor struct {
	...
	DropJobID github_com_cockroachdb_cockroach_pkg_sql_catalog_catpb.JobID `protobuf:"varint,32,opt,name=drop_job_id,json=dropJobId,casttype=sqlfmt/cockroach/pkg/sql/catalog/catpb.JobID" json:"drop_job_id"`
	// Before 22.1:
	...
	GCMutations []TableDescriptor_GCDescriptorMutation `protobuf:"bytes,33,rep,name=gc_mutations,json=gcMutations" json:"gc_mutations"` // Deprecated: Do not use.
...
type TableDescriptor_SchemaChangeLease struct {
	NodeID github_com_cockroachdb_cockroach_pkg_roachpb.NodeID `protobuf:"varint,1,opt,name=node_id,json=nodeId,casttype=sqlfmt/cockroach/pkg/roachpb.NodeID" json:"node_id"`
...
type TableDescriptor_MutationJob struct {
	...
	JobID github_com_cockroachdb_cockroach_pkg_sql_catalog_catpb.JobID `protobuf:"varint,2,opt,name=job_id,json=jobId,casttype=sqlfmt/cockroach/pkg/sql/catalog/catpb.JobID" json:"job_id"`
}
...
type TableDescriptor_GCDescriptorMutation struct {
	...
	// The job id for a mutation job is the id in the system.jobs table of the
	// schema change job executing the mutation referenced by mutation_id.
	JobID github_com_cockroachdb_cockroach_pkg_sql_catalog_catpb.JobID `protobuf:"varint,3,opt,name=job_id,json=jobId,casttype=sqlfmt/cockroach/pkg/sql/catalog/catpb.JobID" json:"job_id"` // Deprecated: Do not use.
}
...
type DatabaseDescriptor_RegionConfig struct {
	...
	PrimaryRegion github_com_cockroachdb_cockroach_pkg_sql_catalog_catpb.RegionName `protobuf:"bytes,3,opt,name=primary_region,json=primaryRegion,casttype=sqlfmt/cockroach/pkg/sql/catalog/catpb.RegionName" json:"primary_region"`
...
type SuperRegion struct {
	...
	Regions         []github_com_cockroachdb_cockroach_pkg_sql_catalog_catpb.RegionName `protobuf:"bytes,2,rep,name=regions,casttype=sqlfmt/cockroach/pkg/sql/catalog/catpb.RegionName" json:"regions,omitempty"`
}
...
type TypeDescriptor_RegionConfig struct {
	...
	PrimaryRegion github_com_cockroachdb_cockroach_pkg_sql_catalog_catpb.RegionName `protobuf:"bytes,1,opt,name=primary_region,json=primaryRegion,casttype=sqlfmt/cockroach/pkg/sql/catalog/catpb.RegionName" json:"primary_region"`
...
var fileDescriptor_12dcc21c3bcc9571 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OnDelete |= catpb.ForeignKeyAction(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 7:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OnUpdate |= catpb.ForeignKeyAction(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}

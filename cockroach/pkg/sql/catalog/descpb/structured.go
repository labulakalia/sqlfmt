...
const (
	...
	// https://sqlfmt/cockroach/blob/master/docs/RFCS/20151214_sql_column_families.md
	FamilyFormatVersion
	// InterleavedFormatVersion corresponds to the encoding described in
	// https://sqlfmt/cockroach/blob/master/docs/RFCS/20160624_sql_interleaved_tables.md

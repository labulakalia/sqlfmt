...
import (
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/sql/contention/txnidcache"
	"github.com/labulakalia/sqlfmt/cockroach/pkg/sql/execstats"
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/sql/sessionphase"
		...
		handleErr := func(err error) {
			if implicitTxn {
				...
				newErr = errors.WithIssueLink(newErr,
					errors.IssueLink{IssueURL: "https://sqlfmt/cockroach/issues/42061"})
				res.SetError(newErr)
			}
		}

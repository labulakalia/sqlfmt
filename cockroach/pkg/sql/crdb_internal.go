...
import (
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/kv/kvclient"
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/sql/catalog/catprivilege"
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/sql/idxusage"
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/sql/sqlstats/persistedsqlstats"
	"github.com/labulakalia/sqlfmt/cockroach/pkg/sql/sqlstats/persistedsqlstats/sqlstatsutil"
	...
	populate: func(ctx context.Context, p *planner, dbContext catalog.DatabaseDescriptor, addRow func(...tree.Datum) error) error {
		return forEachDatabaseDesc(ctx, p, dbContext, true, /* requiresPrivileges */
			func(db catalog.DatabaseDescriptor) error {
				...
				// https://sqlfmt/cockroach/issues/35572

...
type TypeT struct {
	...
	ClosedTypeIDs []github_com_cockroachdb_cockroach_pkg_sql_sem_catid.DescID `protobuf:"varint,2,rep,packed,name=closed_type_ids,json=closedTypeIds,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.DescID" json:"closed_type_ids,omitempty"`
}
...
type Expression struct {
	Expr            github_com_cockroachdb_cockroach_pkg_sql_catalog_catpb.Expression `protobuf:"bytes,1,opt,name=expr,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/catpb.Expression" json:"expr,omitempty"`
	UsesTypeIDs     []github_com_cockroachdb_cockroach_pkg_sql_sem_catid.DescID       `protobuf:"varint,2,rep,packed,name=uses_type_ids,json=usesTypeIds,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.DescID" json:"uses_type_ids,omitempty"`
	UsesSequenceIDs []github_com_cockroachdb_cockroach_pkg_sql_sem_catid.DescID       `protobuf:"varint,3,rep,packed,name=uses_sequence_ids,json=usesSequenceIds,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.DescID" json:"uses_sequence_ids,omitempty"`
}
...
type Column struct {
	TableID                           github_com_cockroachdb_cockroach_pkg_sql_sem_catid.DescID                      `protobuf:"varint,1,opt,name=table_id,json=tableId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.DescID" json:"table_id,omitempty"`
	ColumnID                          github_com_cockroachdb_cockroach_pkg_sql_sem_catid.ColumnID                    `protobuf:"varint,2,opt,name=column_id,json=columnId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.ColumnID" json:"column_id,omitempty"`
...
type ColumnType struct {
	TableID     github_com_cockroachdb_cockroach_pkg_sql_sem_catid.DescID   `protobuf:"varint,1,opt,name=table_id,json=tableId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.DescID" json:"table_id,omitempty"`
	FamilyID    github_com_cockroachdb_cockroach_pkg_sql_sem_catid.FamilyID `protobuf:"varint,2,opt,name=family_id,json=familyId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.FamilyID" json:"family_id,omitempty"`
	ColumnID    github_com_cockroachdb_cockroach_pkg_sql_sem_catid.ColumnID `protobuf:"varint,3,opt,name=column_id,json=columnId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.ColumnID" json:"column_id,omitempty"`
...
type Index struct {
	TableID             github_com_cockroachdb_cockroach_pkg_sql_sem_catid.DescID     `protobuf:"varint,1,opt,name=table_id,json=tableId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.DescID" json:"table_id,omitempty"`
	IndexID             github_com_cockroachdb_cockroach_pkg_sql_sem_catid.IndexID    `protobuf:"varint,2,opt,name=index_id,json=indexId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.IndexID" json:"index_id,omitempty"`
	KeyColumnIDs        []github_com_cockroachdb_cockroach_pkg_sql_sem_catid.ColumnID `protobuf:"varint,3,rep,packed,name=key_column_ids,json=keyColumnIds,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.ColumnID" json:"key_column_ids,omitempty"`
	...
	KeySuffixColumnIDs  []github_com_cockroachdb_cockroach_pkg_sql_sem_catid.ColumnID `protobuf:"varint,5,rep,packed,name=key_suffix_column_ids,json=keySuffixColumnIds,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.ColumnID" json:"key_suffix_column_ids,omitempty"`
	StoringColumnIDs    []github_com_cockroachdb_cockroach_pkg_sql_sem_catid.ColumnID `protobuf:"varint,6,rep,packed,name=storing_column_ids,json=storingColumnIds,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.ColumnID" json:"storing_column_ids,omitempty"`
	CompositeColumnIDs  []github_com_cockroachdb_cockroach_pkg_sql_sem_catid.ColumnID `protobuf:"varint,7,rep,packed,name=composite_column_ids,json=compositeColumnIds,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.ColumnID" json:"composite_column_ids,omitempty"`
	...
	SourceIndexID    github_com_cockroachdb_cockroach_pkg_sql_sem_catid.IndexID `protobuf:"varint,21,opt,name=source_index_id,json=sourceIndexId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.IndexID" json:"source_index_id,omitempty"`
	TemporaryIndexID github_com_cockroachdb_cockroach_pkg_sql_sem_catid.IndexID `protobuf:"varint,22,opt,name=temporary_index_id,json=temporaryIndexId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.IndexID" json:"temporary_index_id,omitempty"`
}
...
type SchemaParent struct {
	SchemaID         github_com_cockroachdb_cockroach_pkg_sql_sem_catid.DescID `protobuf:"varint,1,opt,name=schema_id,json=schemaId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.DescID" json:"schema_id,omitempty"`
	ParentDatabaseID github_com_cockroachdb_cockroach_pkg_sql_sem_catid.DescID `protobuf:"varint,2,opt,name=parent_database_id,json=parentDatabaseId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.DescID" json:"parent_database_id,omitempty"`
}
...
type ObjectParent struct {
	ObjectID       github_com_cockroachdb_cockroach_pkg_sql_sem_catid.DescID `protobuf:"varint,1,opt,name=object_id,json=objectId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.DescID" json:"object_id,omitempty"`
	ParentSchemaID github_com_cockroachdb_cockroach_pkg_sql_sem_catid.DescID `protobuf:"varint,2,opt,name=parent_schema_id,json=parentSchemaId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.DescID" json:"parent_schema_id,omitempty"`
}
...
type Sequence struct {
	SequenceID  github_com_cockroachdb_cockroach_pkg_sql_sem_catid.DescID `protobuf:"varint,1,opt,name=sequence_id,json=sequenceId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.DescID" json:"sequence_id,omitempty"`
...
type SequenceOwner struct {
	SequenceID github_com_cockroachdb_cockroach_pkg_sql_sem_catid.DescID   `protobuf:"varint,1,opt,name=sequence_id,json=sequenceId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.DescID" json:"sequence_id,omitempty"`
	TableID    github_com_cockroachdb_cockroach_pkg_sql_sem_catid.DescID   `protobuf:"varint,2,opt,name=table_id,json=tableId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.DescID" json:"table_id,omitempty"`
	ColumnID   github_com_cockroachdb_cockroach_pkg_sql_sem_catid.ColumnID `protobuf:"varint,3,opt,name=column_id,json=columnId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.ColumnID" json:"column_id,omitempty"`
}
...
type View struct {
	ViewID          github_com_cockroachdb_cockroach_pkg_sql_sem_catid.DescID   `protobuf:"varint,1,opt,name=view_id,json=viewId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.DescID" json:"view_id,omitempty"`
	UsesTypeIDs     []github_com_cockroachdb_cockroach_pkg_sql_sem_catid.DescID `protobuf:"varint,2,rep,packed,name=uses_type_ids,json=usesTypeIds,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.DescID" json:"uses_type_ids,omitempty"`
	UsesRelationIDs []github_com_cockroachdb_cockroach_pkg_sql_sem_catid.DescID `protobuf:"varint,3,rep,packed,name=uses_relation_ids,json=usesRelationIds,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.DescID" json:"uses_relation_ids,omitempty"`
	IsTemporary     bool                                                        `protobuf:"varint,10,opt,name=is_temporary,json=isTemporary,proto3" json:"is_temporary,omitempty"`
...
type UniqueWithoutIndexConstraint struct {
	TableID      github_com_cockroachdb_cockroach_pkg_sql_sem_catid.DescID       `protobuf:"varint,1,opt,name=table_id,json=tableId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.DescID" json:"table_id,omitempty"`
	ConstraintID github_com_cockroachdb_cockroach_pkg_sql_sem_catid.ConstraintID `protobuf:"varint,2,opt,name=constraint_id,json=constraintId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.ConstraintID" json:"constraint_id,omitempty"`
	ColumnIDs    []github_com_cockroachdb_cockroach_pkg_sql_sem_catid.ColumnID   `protobuf:"varint,3,rep,packed,name=column_ids,json=columnIds,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.ColumnID" json:"column_ids,omitempty"`
}
...
type ForeignKeyConstraint struct {
	...
	ConstraintID        github_com_cockroachdb_cockroach_pkg_sql_sem_catid.ConstraintID `protobuf:"varint,2,opt,name=constraint_id,json=constraintId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.ConstraintID" json:"constraint_id,omitempty"`
	ColumnIDs           []github_com_cockroachdb_cockroach_pkg_sql_sem_catid.ColumnID   `protobuf:"varint,3,rep,packed,name=column_ids,json=columnIds,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.ColumnID" json:"column_ids,omitempty"`
	ReferencedTableID   github_com_cockroachdb_cockroach_pkg_sql_sem_catid.DescID       `protobuf:"varint,4,opt,name=referenced_table_id,json=referencedTableId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.DescID" json:"referenced_table_id,omitempty"`
	ReferencedColumnIDs []github_com_cockroachdb_cockroach_pkg_sql_sem_catid.ColumnID   `protobuf:"varint,5,rep,packed,name=referenced_column_ids,json=referencedColumnIds,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.ColumnID" json:"referenced_column_ids,omitempty"`
}
...
type EnumType struct {
	TypeID        github_com_cockroachdb_cockroach_pkg_sql_sem_catid.DescID `protobuf:"varint,1,opt,name=type_id,json=typeId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.DescID" json:"type_id,omitempty"`
	ArrayTypeID   github_com_cockroachdb_cockroach_pkg_sql_sem_catid.DescID `protobuf:"varint,2,opt,name=array_type_id,json=arrayTypeId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.DescID" json:"array_type_id,omitempty"`
...
type Database struct {
	DatabaseID github_com_cockroachdb_cockroach_pkg_sql_sem_catid.DescID `protobuf:"varint,1,opt,name=database_id,json=databaseId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.DescID" json:"database_id,omitempty"`
}
...
type Namespace struct {
	DatabaseID   github_com_cockroachdb_cockroach_pkg_sql_sem_catid.DescID `protobuf:"varint,1,opt,name=database_id,json=databaseId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.DescID" json:"database_id,omitempty"`
	SchemaID     github_com_cockroachdb_cockroach_pkg_sql_sem_catid.DescID `protobuf:"varint,2,opt,name=schema_id,json=schemaId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.DescID" json:"schema_id,omitempty"`
	DescriptorID github_com_cockroachdb_cockroach_pkg_sql_sem_catid.DescID `protobuf:"varint,3,opt,name=descriptor_id,json=descriptorId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.DescID" json:"descriptor_id,omitempty"`
...
type Owner struct {
	DescriptorID github_com_cockroachdb_cockroach_pkg_sql_sem_catid.DescID `protobuf:"varint,1,opt,name=descriptor_id,json=descriptorId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.DescID" json:"descriptor_id,omitempty"`
...
type TableLocalitySecondaryRegion struct {
	TableID          github_com_cockroachdb_cockroach_pkg_sql_sem_catid.DescID         `protobuf:"varint,1,opt,name=table_id,json=tableId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.DescID" json:"table_id,omitempty"`
	RegionEnumTypeID github_com_cockroachdb_cockroach_pkg_sql_sem_catid.DescID         `protobuf:"varint,2,opt,name=region_enum_type_id,json=regionEnumTypeId,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/catid.DescID" json:"region_enum_type_id,omitempty"`
	RegionName       github_com_cockroachdb_cockroach_pkg_sql_catalog_catpb.RegionName `protobuf:"bytes,3,opt,name=region_name,json=regionName,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/catpb.RegionName" json:"region_name,omitempty"`
}

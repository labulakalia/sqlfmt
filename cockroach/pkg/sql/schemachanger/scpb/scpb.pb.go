...
type DescriptorState struct {
	...
	JobID github_com_cockroachdb_cockroach_pkg_sql_catalog_catpb.JobID `protobuf:"varint,5,opt,name=job_id,json=jobId,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/catpb.JobID" json:"job_id,omitempty"`

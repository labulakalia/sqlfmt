...
type TableStatisticProto struct {
	...
	ColumnIDs []github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.ColumnID `protobuf:"varint,4,rep,packed,name=column_ids,json=columnIds,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/descpb.ColumnID" json:"column_ids,omitempty"`

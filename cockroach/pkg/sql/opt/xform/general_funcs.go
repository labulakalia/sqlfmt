...
import (
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/sql/opt/idxconstraint"
	"github.com/labulakalia/sqlfmt/cockroach/pkg/sql/opt/memo"
	"github.com/labulakalia/sqlfmt/cockroach/pkg/sql/opt/norm"
	"github.com/labulakalia/sqlfmt/cockroach/pkg/sql/opt/ordering"
	"github.com/labulakalia/sqlfmt/cockroach/pkg/sql/opt/partialidx"
...
func (c *CustomFuncs) splitScanIntoUnionScansOrSelects(
	...
	//   https://sqlfmt/cockroach/pull/38216), or maybe just set
	...
	if hardMaxScanCount == 0 {
		...
		//   https://sqlfmt/cockroach/pull/73267
		hardMaxScanCount = 16
	}

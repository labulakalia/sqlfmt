...
type IndexContentionEvents struct {
	...
	IndexID github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.IndexID `protobuf:"varint,2,opt,name=index_id,json=indexId,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/descpb.IndexID" json:"index_id,omitempty"`
...
type SingleTxnContention struct {
	...
	TxnID github_com_cockroachdb_cockroach_pkg_util_uuid.UUID `protobuf:"bytes,2,opt,name=txn_id,json=txnId,proto3,customtype=sqlfmt/cockroach/pkg/util/uuid.UUID" json:"txn_id"`
...
type SingleKeyContention struct {
	...
	Key github_com_cockroachdb_cockroach_pkg_roachpb.Key `protobuf:"bytes,1,opt,name=key,proto3,casttype=sqlfmt/cockroach/pkg/roachpb.Key" json:"key,omitempty"`
...
type ResolvedTxnID struct {
	TxnID github_com_cockroachdb_cockroach_pkg_util_uuid.UUID `protobuf:"bytes,1,opt,name=txnID,proto3,customtype=sqlfmt/cockroach/pkg/util/uuid.UUID" json:"txnID"`
	...
	TxnFingerprintID github_com_cockroachdb_cockroach_pkg_roachpb.TransactionFingerprintID `protobuf:"varint,2,opt,name=txnFingerprintID,proto3,customtype=sqlfmt/cockroach/pkg/roachpb.TransactionFingerprintID" json:"txnFingerprintID"`
}
...
type ExtendedContentionEvent struct {
	...
	BlockingTxnFingerprintID github_com_cockroachdb_cockroach_pkg_roachpb.TransactionFingerprintID `protobuf:"varint,2,opt,name=blocking_txn_fingerprint_id,json=blockingTxnFingerprintId,proto3,casttype=sqlfmt/cockroach/pkg/roachpb.TransactionFingerprintID" json:"blocking_txn_fingerprint_id,omitempty"`
	WaitingTxnID             github_com_cockroachdb_cockroach_pkg_util_uuid.UUID                   `protobuf:"bytes,3,opt,name=waiting_txn_id,json=waitingTxnId,proto3,customtype=sqlfmt/cockroach/pkg/util/uuid.UUID" json:"waiting_txn_id"`
	WaitingTxnFingerprintID  github_com_cockroachdb_cockroach_pkg_roachpb.TransactionFingerprintID `protobuf:"varint,4,opt,name=waiting_txn_fingerprint_id,json=waitingTxnFingerprintId,proto3,casttype=sqlfmt/cockroach/pkg/roachpb.TransactionFingerprintID" json:"waiting_txn_fingerprint_id,omitempty"`

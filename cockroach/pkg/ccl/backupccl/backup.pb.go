...
import (
	fmt "fmt"
	build "github.com/labulakalia/sqlfmt/cockroach/pkg/build"
	...
	stats "github.com/labulakalia/sqlfmt/cockroach/pkg/sql/stats"
...
func (ScheduledBackupExecutionArgs_BackupType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_0a83e09f0e5986cc, []int{3, 0}
}
...
type BackupManifest struct {
	...
	CompleteDbs   []github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.ID `protobuf:"varint,14,rep,packed,name=complete_dbs,json=completeDbs,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/descpb.ID" json:"complete_dbs,omitempty"`
	...
	ClusterID     github_com_cockroachdb_cockroach_pkg_util_uuid.UUID          `protobuf:"bytes,9,opt,name=cluster_id,json=clusterId,proto3,customtype=sqlfmt/cockroach/pkg/util/uuid.UUID" json:"cluster_id"`
	// node_id and build_info of the gateway node (which writes the descriptor).
	NodeID                       github_com_cockroachdb_cockroach_pkg_roachpb.NodeID `protobuf:"varint,10,opt,name=node_id,json=nodeId,proto3,casttype=sqlfmt/cockroach/pkg/roachpb.NodeID" json:"node_id,omitempty"`
	...
	ID                           github_com_cockroachdb_cockroach_pkg_util_uuid.UUID `protobuf:"bytes,18,opt,name=id,proto3,customtype=sqlfmt/cockroach/pkg/util/uuid.UUID" json:"id"`
	...
	StatisticsFilenames  map[github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.ID]string `protobuf:"bytes,23,rep,name=statistics_filenames,json=statisticsFilenames,proto3,castkey=sqlfmt/cockroach/pkg/sql/catalog/descpb.ID" json:"statistics_filenames,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	DescriptorCoverage   github_com_cockroachdb_cockroach_pkg_sql_sem_tree.DescriptorCoverage  `protobuf:"varint,22,opt,name=descriptor_coverage,json=descriptorCoverage,proto3,casttype=sqlfmt/cockroach/pkg/sql/sem/tree.DescriptorCoverage" json:"descriptor_coverage,omitempty"`
}
...
func (*BackupManifest_File) Descriptor() ([]byte, []int) {
	return fileDescriptor_0a83e09f0e5986cc, []int{0, 0}
}
...
func (*BackupManifest_DescriptorRevision) Descriptor() ([]byte, []int) {
	return fileDescriptor_0a83e09f0e5986cc, []int{0, 1}
}
...
func (*BackupManifest_Progress) Descriptor() ([]byte, []int) {
	return fileDescriptor_0a83e09f0e5986cc, []int{0, 2}
}
...
type BackupPartitionDescriptor struct {
	...
	BackupID   github_com_cockroachdb_cockroach_pkg_util_uuid.UUID `protobuf:"bytes,3,opt,name=backup_id,json=backupId,proto3,customtype=sqlfmt/cockroach/pkg/util/uuid.UUID" json:"backup_id"`
}
...
type ScheduledBackupExecutionArgs struct {
	...
	ProtectedTimestampRecord       *github_com_cockroachdb_cockroach_pkg_util_uuid.UUID `protobuf:"bytes,8,opt,name=protected_timestamp_record,json=protectedTimestampRecord,proto3,customtype=sqlfmt/cockroach/pkg/util/uuid.UUID" json:"protected_timestamp_record,omitempty"`
}
...
type BackupExportTraceResponseEvent struct {
	...
	FileSummaries  []roachpb.RowCount `protobuf:"bytes,3,rep,name=file_summaries,json=fileSummaries,proto3" json:"file_summaries"`
...
var fileDescriptor_0a83e09f0e5986cc = []byte{
	...
	,
}
...
func (m *BackupExportTraceResponseEvent) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.FileSummaries = append(m.FileSummaries, roachpb.RowCount{})

...
import (
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/ccl/changefeedccl/kvevent"
	...
	_ "github.com/labulakalia/sqlfmt/cockroach/pkg/cloud/impl" // registers cloud storage providers
	...
	for _, tc := range []struct {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			/*
						...
						// but https://sqlfmt/cockroach/issues/49313 deeply breaks

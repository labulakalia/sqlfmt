...
import (
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/cli/syncbench"
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/kv/kvserver/gc"
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/sql/catalog/descbuilder"
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/util/flagutil"
...
func removeDeadReplicas(
	...
	err = kvserver.IterateRangeDescriptorsFromDisk(ctx, db, func(desc roachpb.RangeDescriptor) error {
		...
		for _, rep := range allReplicas {
			...
			//
			// https://sqlfmt/cockroach/issues/33007
...
// See: https://sqlfmt/cockroach/issues/49509

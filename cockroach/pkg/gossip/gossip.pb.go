...
type Request struct {
	...
	HighWaterStamps map[github_com_cockroachdb_cockroach_pkg_roachpb.NodeID]int64 `protobuf:"bytes,3,rep,name=high_water_stamps,json=highWaterStamps,proto3,castkey=sqlfmt/cockroach/pkg/roachpb.NodeID" json:"high_water_stamps" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	...
	ClusterID github_com_cockroachdb_cockroach_pkg_util_uuid.UUID `protobuf:"bytes,5,opt,name=cluster_id,json=clusterId,proto3,customtype=sqlfmt/cockroach/pkg/util/uuid.UUID" json:"cluster_id"`
}
...
type Response struct {
	...
	AlternateNodeID github_com_cockroachdb_cockroach_pkg_roachpb.NodeID `protobuf:"varint,4,opt,name=alternate_node_id,json=alternateNodeId,proto3,casttype=sqlfmt/cockroach/pkg/roachpb.NodeID" json:"alternate_node_id,omitempty"`
...
type Connectivity struct {
	SentinelNodeID github_com_cockroachdb_cockroach_pkg_roachpb.NodeID `protobuf:"varint,1,opt,name=sentinel_node_id,json=sentinelNodeId,proto3,casttype=sqlfmt/cockroach/pkg/roachpb.NodeID" json:"sentinel_node_id,omitempty"`
...
type Connectivity_Conn struct {
	SourceID github_com_cockroachdb_cockroach_pkg_roachpb.NodeID `protobuf:"varint,1,opt,name=source_id,json=sourceId,proto3,casttype=sqlfmt/cockroach/pkg/roachpb.NodeID" json:"source_id,omitempty"`
	TargetID github_com_cockroachdb_cockroach_pkg_roachpb.NodeID `protobuf:"varint,2,opt,name=target_id,json=targetId,proto3,casttype=sqlfmt/cockroach/pkg/roachpb.NodeID" json:"target_id,omitempty"`
}
...
type Info struct {
	...
	NodeID github_com_cockroachdb_cockroach_pkg_roachpb.NodeID `protobuf:"varint,5,opt,name=node_id,json=nodeId,proto3,casttype=sqlfmt/cockroach/pkg/roachpb.NodeID" json:"node_id,omitempty"`
	// Peer node ID which passed this info.
	PeerID github_com_cockroachdb_cockroach_pkg_roachpb.NodeID `protobuf:"varint,6,opt,name=peer_id,json=peerId,proto3,casttype=sqlfmt/cockroach/pkg/roachpb.NodeID" json:"peer_id,omitempty"`
}

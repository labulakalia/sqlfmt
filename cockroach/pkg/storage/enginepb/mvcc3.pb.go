...
type TxnMeta struct {
	...
	ID github_com_cockroachdb_cockroach_pkg_util_uuid.UUID `protobuf:"bytes,1,opt,name=id,proto3,customtype=sqlfmt/cockroach/pkg/util/uuid.UUID" json:"id"`
...
type MVCCWriteIntentOp struct {
	TxnID           github_com_cockroachdb_cockroach_pkg_util_uuid.UUID `protobuf:"bytes,1,opt,name=txn_id,json=txnId,proto3,customtype=sqlfmt/cockroach/pkg/util/uuid.UUID" json:"txn_id"`
...
var fileDescriptor_6599d13285d4d9cc = []byte{
	...
	,
}
...
func (m *RangeAppliedState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.RaftAppliedIndexTerm != 0 {
		i = encodeVarintMvcc3(dAtA, i, uint64(m.RaftAppliedIndexTerm))
		i--
		dAtA[i] = 0x28
	}
...
func NewPopulatedRangeAppliedState(r randyMvcc3, easy bool) *RangeAppliedState {
	...
	this.RaftAppliedIndexTerm = uint64(uint64(r.Uint32()))
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func (m *RangeAppliedState) Size() (n int) {
	...
	if m.RaftAppliedIndexTerm != 0 {
		n += 1 + sovMvcc3(uint64(m.RaftAppliedIndexTerm))
	}
	return n
}

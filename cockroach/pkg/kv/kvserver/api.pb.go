...
type CollectChecksumRequest struct {
	...
	RangeID            github_com_cockroachdb_cockroach_pkg_roachpb.RangeID `protobuf:"varint,2,opt,name=range_id,json=rangeId,proto3,casttype=sqlfmt/cockroach/pkg/roachpb.RangeID" json:"range_id,omitempty"`
	// checksum_id identifies the corresponding roachpb.ComputeChecksumRequest.
	ChecksumID github_com_cockroachdb_cockroach_pkg_util_uuid.UUID `protobuf:"bytes,3,opt,name=checksum_id,json=checksumId,proto3,customtype=sqlfmt/cockroach/pkg/util/uuid.UUID" json:"checksum_id"`
...
type CollectChecksumResponse struct {
	...
	// See https://sqlfmt/cockroach/issues/21128.

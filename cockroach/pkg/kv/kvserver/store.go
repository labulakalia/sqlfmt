...
import (
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/kv/kvserver/idalloc"
	"github.com/labulakalia/sqlfmt/cockroach/pkg/kv/kvserver/intentresolver"
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/kv/kvserver/raftentry"
	"github.com/labulakalia/sqlfmt/cockroach/pkg/kv/kvserver/rangefeed"
	"github.com/labulakalia/sqlfmt/cockroach/pkg/kv/kvserver/tenantrate"
	"github.com/labulakalia/sqlfmt/cockroach/pkg/kv/kvserver/tscache"
	"github.com/labulakalia/sqlfmt/cockroach/pkg/kv/kvserver/txnrecovery"
	"github.com/labulakalia/sqlfmt/cockroach/pkg/kv/kvserver/txnwait"
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/util/limit"
...
func (s *Store) SetDraining(drain bool, reporter func(int, redact.SafeString), verbose bool) {
	...
	if err := contextutil.RunWithTimeout(ctx, drainLeasesOp, transferTimeout,
		func(ctx context.Context) error {
			...
			var err error
			// Avoid retry.ForDuration because of https://sqlfmt/cockroach/issues/25091.

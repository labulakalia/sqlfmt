...
type RangeLogEvent struct {
	...
	StoreID      github_com_cockroachdb_cockroach_pkg_roachpb.StoreID `protobuf:"varint,3,opt,name=store_id,json=storeId,proto3,casttype=sqlfmt/cockroach/pkg/roachpb.StoreID" json:"store_id,omitempty"`
	...
	OtherRangeID github_com_cockroachdb_cockroach_pkg_roachpb.RangeID `protobuf:"varint,5,opt,name=other_range_id,json=otherRangeId,proto3,casttype=sqlfmt/cockroach/pkg/roachpb.RangeID" json:"other_range_id,omitempty"`

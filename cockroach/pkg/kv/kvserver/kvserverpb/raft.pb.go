...
type RaftHeartbeat struct {
	RangeID                   github_com_cockroachdb_cockroach_pkg_roachpb.RangeID   `protobuf:"varint,1,opt,name=range_id,json=rangeId,proto3,casttype=sqlfmt/cockroach/pkg/roachpb.RangeID" json:"range_id,omitempty"`
	FromReplicaID             github_com_cockroachdb_cockroach_pkg_roachpb.ReplicaID `protobuf:"varint,2,opt,name=from_replica_id,json=fromReplicaId,proto3,casttype=sqlfmt/cockroach/pkg/roachpb.ReplicaID" json:"from_replica_id,omitempty"`
	ToReplicaID               github_com_cockroachdb_cockroach_pkg_roachpb.ReplicaID `protobuf:"varint,3,opt,name=to_replica_id,json=toReplicaId,proto3,casttype=sqlfmt/cockroach/pkg/roachpb.ReplicaID" json:"to_replica_id,omitempty"`
...
type RaftMessageRequest struct {
	...
	RangeStartKey github_com_cockroachdb_cockroach_pkg_roachpb.RKey `protobuf:"bytes,8,opt,name=range_start_key,json=rangeStartKey,proto3,casttype=sqlfmt/cockroach/pkg/roachpb.RKey" json:"range_start_key,omitempty"`
...
var fileDescriptor_755441ac72dfaa3b = []byte{
	...
	,
}

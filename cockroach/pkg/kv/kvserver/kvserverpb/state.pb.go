...
import (
	fmt "fmt"
	github_com_cockroachdb_cockroach_pkg_kv_kvserver_closedts_ctpb "github.com/labulakalia/sqlfmt/cockroach/pkg/kv/kvserver/closedts/ctpb"
...
type RangeSideTransportInfo struct {
	...
	ReplicaLAI    github_com_cockroachdb_cockroach_pkg_kv_kvserver_closedts_ctpb.LAI `protobuf:"varint,2,opt,name=replica_lai,json=replicaLai,proto3,casttype=sqlfmt/cockroach/pkg/kv/kvserver/closedts/ctpb.LAI" json:"replica_lai,omitempty"`
	CentralClosed hlc.Timestamp                                                      `protobuf:"bytes,3,opt,name=central_closed,json=centralClosed,proto3" json:"central_closed"`
	CentralLAI    github_com_cockroachdb_cockroach_pkg_kv_kvserver_closedts_ctpb.LAI `protobuf:"varint,4,opt,name=central_lai,json=centralLai,proto3,casttype=sqlfmt/cockroach/pkg/kv/kvserver/closedts/ctpb.LAI" json:"central_lai,omitempty"`
}
...
var fileDescriptor_cc107fbd3ff296cb = []byte{
	...
	,
}

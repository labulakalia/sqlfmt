...
import (
	...
	"sqlfmt/cockroach/pkg/kv/kvserver/split"
...
type Replica struct {
	...
	// purpose.
	//
	// [1]: https://sqlfmt/cockroach/pull/16664
...
func (r *Replica) assertStateRaftMuLockedReplicaMuRLocked(
	...
	//
	// See:
	// https://sqlfmt/cockroach/pull/40892

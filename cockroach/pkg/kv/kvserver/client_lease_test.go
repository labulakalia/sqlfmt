...
// This verifies https://sqlfmt/cockroach/issues/67740
...
// https://sqlfmt/cockroach/issues/62485. We verify that
...
func TestLeasePreferencesDuringOutage(t *testing.T) {
	...
	skip.UnderStress(t, "https://sqlfmt/cockroach/issues/70113")

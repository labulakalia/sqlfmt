...
type Record struct {
	...
	ID github_com_cockroachdb_cockroach_pkg_util_uuid.Bytes `protobuf:"bytes,1,opt,name=id,proto3,casttype=sqlfmt/cockroach/pkg/util/uuid.Bytes" json:"id,omitempty"`
...
type Target_SchemaObjectsTarget struct {
	...
	IDs []github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.ID `protobuf:"varint,1,rep,packed,name=ids,proto3,casttype=sqlfmt/cockroach/pkg/sql/catalog/descpb.ID" json:"ids,omitempty"`
}

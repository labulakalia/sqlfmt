...
//
// sqlfmt/cockroach/pkg/storage.(*Replica).sendWithRangeID(0xc420d1a000, 0x64bfb80, 0xc421564b10, 0x15, 0x153fd4634aeb0193, 0x0, 0x100000001, 0x1, 0x15, 0x0, ...)
...
func (r *Replica) maybeCommitWaitBeforeCommitTrigger(
	...
	//   https://sqlfmt/cockroach/blob/master/docs/RFCS/20200811_non_blocking_txns.md
	//

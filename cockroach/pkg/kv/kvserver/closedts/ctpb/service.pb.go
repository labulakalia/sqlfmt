...
type Update struct {
	...
	// longer tracked.
	Removed        []github_com_cockroachdb_cockroach_pkg_roachpb.RangeID `protobuf:"varint,5,rep,packed,name=removed,proto3,casttype=sqlfmt/cockroach/pkg/roachpb.RangeID" json:"removed,omitempty"`

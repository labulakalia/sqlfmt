...
import (
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/kv/kvserver/closedts/tracker"
	...
	for i, p := range buf {
		...
		if crt := p.command.ReplicatedEvalResult.ChangeReplicas; crt != nil {
			...
			if err := raftGroup.ProposeConfChange(
				...
				// https://sqlfmt/cockroach/issues/21849
				firstErr = err
				continue
			}
		} else {
...
func (b *propBuf) allocateLAIAndClosedTimestampLocked(
	...
	//
	// See https://sqlfmt/cockroach/issues/72428#issuecomment-976428551.

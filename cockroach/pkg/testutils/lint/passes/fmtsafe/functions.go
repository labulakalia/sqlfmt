...
import (
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/testutils/lint/passes/errwrap"
...
var requireConstMsg = map[string]bool{
	"github.com/labulakalia/sqlfmt/cockroach/pkg/util/log.Shout":     true,
	"github.com/labulakalia/sqlfmt/cockroach/pkg/util/log.Event":     true,
	"github.com/labulakalia/sqlfmt/cockroach/pkg/util/log.VEvent":    true,
	"github.com/labulakalia/sqlfmt/cockroach/pkg/util/log.VErrEvent": true,
...
var requireConstFmt = map[string]bool{
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/util/log.Shoutf":          true,
	"github.com/labulakalia/sqlfmt/cockroach/pkg/util/log.Eventf":          true,
	"github.com/labulakalia/sqlfmt/cockroach/pkg/util/log.vEventf":         true,
	"github.com/labulakalia/sqlfmt/cockroach/pkg/util/log.VEventf":         true,
	"github.com/labulakalia/sqlfmt/cockroach/pkg/util/log.VErrEventf":      true,
	"github.com/labulakalia/sqlfmt/cockroach/pkg/util/log.VEventfDepth":    true,
	"github.com/labulakalia/sqlfmt/cockroach/pkg/util/log.VErrEventfDepth": true,

	// Note: More of the logging functions are populated here via the
	// init() function below.

	"github.com/labulakalia/sqlfmt/cockroach/pkg/util/log.MakeLegacyEntry":        true,
	"github.com/labulakalia/sqlfmt/cockroach/pkg/util/log.makeUnstructuredEntry":  true,
	"github.com/labulakalia/sqlfmt/cockroach/pkg/util/log.FormatWithContextTags":  true,
	"github.com/labulakalia/sqlfmt/cockroach/pkg/util/log.formatOnlyArgs":         true,
	"github.com/labulakalia/sqlfmt/cockroach/pkg/util/log.renderArgsAsRedactable": true,
	"github.com/labulakalia/sqlfmt/cockroach/pkg/util/log.formatArgs":             true,
	"github.com/labulakalia/sqlfmt/cockroach/pkg/util/log.logfDepth":              true,
	"github.com/labulakalia/sqlfmt/cockroach/pkg/util/log.shoutfDepth":            true,
	"github.com/labulakalia/sqlfmt/cockroach/pkg/util/log.makeStartLine":          true,

	"github.com/labulakalia/sqlfmt/cockroach/pkg/util/log/logcrash.ReportOrPanic": true,

	"github.com/labulakalia/sqlfmt/cockroach/pkg/roachpb.NewAmbiguousResultErrorf": true,
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/kv/kvserver.makeNonDeterministicFailure":     true,
	"github.com/labulakalia/sqlfmt/cockroach/pkg/kv/kvserver.wrapWithNonDeterministicFailure": true,
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/sql/opt/optgen/exprgen.errorf": true,
	"github.com/labulakalia/sqlfmt/cockroach/pkg/sql/opt/optgen/exprgen.wrapf":  true,
	...
	"github.com/labulakalia/sqlfmt/cockroach/pkg/server.serverErrorf":        true,
	"github.com/labulakalia/sqlfmt/cockroach/pkg/server.guaranteedExitFatal": true,
...
func init() {
	for _, sev := range logpb.Severity_name {
		...
		requireConstFmt["github.com/labulakalia/sqlfmt/cockroach/pkg/util/log."+capsev+"f"] = true
		// log.VInfof, log.VWarningf etc.
		requireConstFmt["github.com/labulakalia/sqlfmt/cockroach/pkg/util/log.V"+capsev+"f"] = true
		// log.InfofDepth, log.WarningfDepth, etc.
		requireConstFmt["github.com/labulakalia/sqlfmt/cockroach/pkg/util/log."+capsev+"fDepth"] = true
		// log.Info, log.Warning, etc.
		requireConstMsg["github.com/labulakalia/sqlfmt/cockroach/pkg/util/log."+capsev] = true

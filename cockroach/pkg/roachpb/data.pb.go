...
import (
	bytes "bytes"
	fmt "fmt"
	lock "sqlfmt/cockroach/pkg/kv/kvserver/concurrency/lock"
	rspb "sqlfmt/cockroach/pkg/kv/kvserver/readsummary/rspb"
	enginepb "sqlfmt/cockroach/pkg/storage/enginepb"
	github_com_cockroachdb_cockroach_pkg_storage_enginepb "sqlfmt/cockroach/pkg/storage/enginepb"
...
type StoreIdent struct {
	ClusterID github_com_cockroachdb_cockroach_pkg_util_uuid.UUID `protobuf:"bytes,1,opt,name=cluster_id,json=clusterId,proto3,customtype=sqlfmt/cockroach/pkg/util/uuid.UUID" json:"cluster_id"`
...
type MergeTrigger struct {
	...
	FreezeStart github_com_cockroachdb_cockroach_pkg_util_hlc.ClockTimestamp `protobuf:"bytes,5,opt,name=freeze_start,json=freezeStart,proto3,casttype=sqlfmt/cockroach/pkg/util/hlc.ClockTimestamp" json:"freeze_start"`
...
type ObservedTimestamp struct {
	...
	Timestamp github_com_cockroachdb_cockroach_pkg_util_hlc.ClockTimestamp `protobuf:"bytes,2,opt,name=timestamp,proto3,casttype=sqlfmt/cockroach/pkg/util/hlc.ClockTimestamp" json:"timestamp"`
}
...
type Lease struct {
	...
	Start github_com_cockroachdb_cockroach_pkg_util_hlc.ClockTimestamp `protobuf:"bytes,1,opt,name=start,proto3,casttype=sqlfmt/cockroach/pkg/util/hlc.ClockTimestamp" json:"start"`
	...
	ProposedTS *github_com_cockroachdb_cockroach_pkg_util_hlc.ClockTimestamp `protobuf:"bytes,5,opt,name=proposed_ts,json=proposedTs,proto3,casttype=sqlfmt/cockroach/pkg/util/hlc.ClockTimestamp" json:"proposed_ts,omitempty"`
...
type LeafTxnFinalState struct {
	...
	// See: https://sqlfmt/cockroach/issues/43192
	Txn Transaction `protobuf:"bytes,1,opt,name=txn,proto3" json:"txn"`
...
var fileDescriptor_6493e3a32c32e46b = []byte{
	...
	,
}

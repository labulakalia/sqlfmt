...
type PingRequest struct {
	...
	ClusterID     *github_com_cockroachdb_cockroach_pkg_util_uuid.UUID `protobuf:"bytes,5,opt,name=origin_cluster_id,json=originClusterId,customtype=sqlfmt/cockroach/pkg/util/uuid.UUID" json:"origin_cluster_id,omitempty"`
	...
	TargetNodeID github_com_cockroachdb_cockroach_pkg_roachpb.NodeID `protobuf:"varint,7,opt,name=target_node_id,json=targetNodeId,customtype=sqlfmt/cockroach/pkg/roachpb.NodeID" json:"target_node_id"`
	// NodeID of the originator of the PingRequest.
	OriginNodeID github_com_cockroachdb_cockroach_pkg_roachpb.NodeID `protobuf:"varint,8,opt,name=origin_node_id,json=originNodeId,customtype=sqlfmt/cockroach/pkg/roachpb.NodeID" json:"origin_node_id"`
}

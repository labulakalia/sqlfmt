...
import (
	...
	rperrors "github.com/labulakalia/sqlfmt/cockroach/pkg/roachprod/errors"
	"github.com/labulakalia/sqlfmt/cockroach/pkg/roachprod/logger"
	"github.com/labulakalia/sqlfmt/cockroach/pkg/roachprod/ssh"
	"github.com/labulakalia/sqlfmt/cockroach/pkg/roachprod/ui"
		...
		go func(i int) {
			...
			if c.IsLocal() {
				...
				copy = func(src, dest string, info os.FileInfo) error {
					...
					// See:
					// https://sqlfmt/cockroach/issues/44843
					mode := info.Mode() | 0444
					if info.IsDir() {
